        ...
        while True:
            ...
            if option == 1:
                ...
                if nick == None:
                    ...
                    print(f"[{info_character[f"{option}"]["Name"]}]") 
                    print(f"Level: {info_character[f"{option}"]["Level"]}") 
                    print(f"Força: {info_character[f"{option}"]["Strength"]}") 
                    print(f"Defesa: {info_character[f"{option}"]["Defense"]}") 
                    print(f"Vida: {info_character[f"{option}"]["Health"]}") 
                    print(f"Você está em: {info_character[f"{option}"]["City"]}\n") 
                    
                    #Method to call menus. Caçar, Mover, Loja
                    self.character.menuInteractions(info_character[f"{option}"]["Name"], login) 
    ...
    def windowLoggedWelcome(self,id_login, name, email, login, nick, level):
        ...
        while True:
            ...
            if option == 1:
                ...
                print(f"[{info_character[option]["Nome"]}]") 
                print(f"Level: {info_character[option]["Level"]}") 
                print(f"Força: {info_character[option]["Strength"]}") 
                print(f"Defesa: {info_character[option]["Defense"]}") 
                print(f"Vida: {info_character[option]["Health"]}") 
                print(f"Você está em: {info_character[option]["City"]}\n") 
